...
export function OverallRating() {
  return (
    <div className="rounded-2xl w-36 p-4 bg-indigo-500 dark:bg-gray-800">
      <div className="flex items-center">
        ...
        <p className="text-md text-white dark:text-gray-50 ml-1">Rating</p>
      </div>
      <div className="flex flex-col justify-start">
        <p className="text-white text-4xl text-left dark:text-white font-bold my-2">4.3</p>
